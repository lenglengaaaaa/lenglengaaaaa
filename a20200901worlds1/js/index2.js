...
$('.nav-box .btn-expand').click(function() {
    $('.navbar').show();
    $('.nav-box').css({ 'width': '163px', 'height': '692px', 'background': 'url(//game.gtimg.cn/images/lpl/act/a20200901worlds/nav-bg.png) no-repeat', 'right': '18px' });
...
var eventUtil = {
    ...
    cont5Swiper: function() {
        ...
        var jsList = [
            { "img": "ossweb-img/js-name37.png", "name": "余霜" },
            { "img": "ossweb-img/js-name38.png", "name": "希然" },
            { "img": "ossweb-img/js-name39.png", "name": "刘航" },
            { "img": "ossweb-img/js-name40.png", "name": "小钰" },
            { "img": "ossweb-img/js-name41.png", "name": "骆歆" },
...
/* #t6Hl8#BDB0AC6961C9954F01CC6C3EB3519C26 */