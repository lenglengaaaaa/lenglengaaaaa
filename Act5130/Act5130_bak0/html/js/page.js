...
//3锟斤拷flash锟斤拷锟斤拷锟斤拷锟酵ㄖ猨s  flash->js
...
var SWFOBJo= new Lottery({
      ...
      'width':580,//flash宽度
      'height':580,//flash高度
      's':'//game.gtimg.cn/images/slg/act/5130/a20210225newstar/page/btn-lottery.png',//开始抽奖按钮图片
      ...
      'onClickRollEvent' : callJsToStarto,//对应上面接口
        'onCompleteRollEvent':callJsToCompleteo
});
