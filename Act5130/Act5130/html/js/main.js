    ...
    if (type == 'img') {
        fillNews.detail({
            ...
            callback: function (obj) {
                ...
                document.title='乱世九鼎-乱世王者-官方网站-腾讯游戏'
            }
        });
    }
}
...
// 淘汰赛文案
var teamData={
    'area':['第一赛区','第二赛区','第三赛区','第四赛区','第五赛区','第六赛区','第七赛区','第八赛区','第九赛区','第十赛区','第十一赛区','第十二赛区','第十三赛区','第十四赛区','第十五赛区','第十六赛区'],
    'name':[]
}
var teamArea=teamData.area;
$.each(teamArea,function(i,value) {
    $('.finalis-cont1 .first-list .finalisout-area').eq(i).html(value);
    $('.finalis-cont2 .first-list .finalisout-area').eq(i).html(value);
});
