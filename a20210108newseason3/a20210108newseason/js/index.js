...
$('.dia-receive3 .select').on('click',function(){
	var idx=$(this).parent().parent().index();
	$(this).parent().parent().addClass('on').siblings('li').removeClass('on');
})

/* #t6Hl8#C0DB438BE77E3DE32D6EA26AAC7AEDFD */