    ...
    function hidediv(){
        setTimeout(function(){
            ...
            $('.header .slogan').css({
                width:'4.57rem',
                height:'.72rem',
                background:'url(//game.gtimg.cn/images/lpl/act/a20200706partner/slogan1.png) 0 0 /4.57rem .72rem',
                margin:'.83rem 0 0 .15rem',
                transition:'.5s linear'
            });
            $('.header .time').css({
                width:'3.4rem',
            ...
            $('.logo').css({top:'.45rem',left:'.15rem', width:'.95rem',height:'.29rem'});
            $('.logo1').css({top:'.49rem',left:'1.2rem', width:'1.13rem',height:'.2rem'});
