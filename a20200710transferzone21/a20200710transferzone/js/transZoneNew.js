var TransZone = {
                            ...
                            if (transCheck_RES.iRet == 0) {
                                ...
                                if (iframe.attachEvent) {
                                    iframe.attachEvent("onload", function () {
                                        ...
                                        if (btn) {
                                            btn.href = "javascript:parent.closeDialogs()";
                                        }
                                    });
                                } else {
                                ...
                                TGDialogS('infoMsg2')
                                //var sHtml = '<iframe id="iframe1" src="'+transCheck_RES.msg+'" frameborder="0"  width="413" height="291"></iframe>';
                                //$('#infoMsg2').html(sHtml);
                                //TGDialogS('infoMsg2')
                            } else {
                            ...
                            if (transCheck_RES.iRet == 0) {
                                ...
                                if (iframe.attachEvent) {
                                    iframe.attachEvent("onload", function () {
                                        ...
                                        if (btn) {
                                            btn.href = "javascript:parent.closeDialogs()";
                                            btn.onclick = "parent.closeDialogs()";
                                        }
    ...
    ShowPage: function (num) {
        ...
        for (var i = 1; i <= 5; i++) {
            if (i == num) {
                ...
                if(!/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) {
                    if (num == 4) {
                        $('.content2').css('background', 'url(//game.gtimg.cn/images/lol/act/a20200710transferzone/bg1.jpg) no-repeat 50% 0');
                        $('.cont2-matter').css('height', 'auto');
                    } else if (num == 5) {
                        $('.content2').css('background', 'url(//game.gtimg.cn/images/lol/act/a20200710transferzone/bg1.jpg) no-repeat 50% 0');
                        $('.cont2-matter').css('height', 'auto');
                    } else {
                        $('.content2').css('background', 'url(//game.gtimg.cn/images/lol/act/a20200710transferzone/bg2.jpg) no-repeat 50% 0');
                        $('.cont2-matter').css('height', ' 931px');
                    }
                }
            } else {
    ...
    getFreeNum:function(){
        ...
        need("biz.login", function (LoginManager) {
            LoginManager.checkLogin(function () {
                var sUrl = "//lol.sw.game.qq.com/lol/lwdcommact/a20200730increaseLevel/LOLPlanTrans/getFreeNum?r1=TransUserInfo_RES";
                loadScript(sUrl, function () {
                    if (TransUserInfo_RES) {
                        if (TransUserInfo_RES.status == 0) {
                            if(TransUserInfo_RES.count>0){
                                var nextNum=TransUserInfo_RES.count-1;
                                nextNum=nextNum<0?0:nextNum;
                                $("#nowFreeNum").html('(剩余'+TransUserInfo_RES.count+'次)');
                                $("#nowFreeNum2").html('(剩余'+TransUserInfo_RES.count+'次)');
                                $("#nextFreeNum").html(nextNum+'次');
                                $("#freeTransZone").show();
                                $("#freeTransZone2").show();
                            }else{
                                $("#freeTransZone").hide();
    ...
    freeTransferZone:function(){
        closeDialog();
        var self = TransZone;
        need("biz.login", function (LoginManager) {
            LoginManager.checkLogin(function () {
                var sUrl = "//lol.sw.game.qq.com/lol/lwdcommact/a20200730increaseLevel/LOLPlanTrans/freeTransferZone?r1=TransUserInfo_RES";
                loadScript(sUrl, function () {
                    if (TransUserInfo_RES) {
                        if (TransUserInfo_RES.status == 0) {
                            TransZone.ShowPage(5);
                        }else{
                            $("#msg").html(TransUserInfo_RES.msg);
                            TGDialogS("infoMsg");
                        }
                    }
                })
    ...
    TransferZoneList:function (page) {
        ...
        need("biz.login", function (LoginManager) {
            LoginManager.checkLogin(function () {
                var sUrl = "//lol.sw.game.qq.com/lol/lwdcommact/a20210106transferzone/a20210106transferzone/TransferZoneList?page="+page+"&pageSize="+pageSize+"&r1=TransferZoneList_RES";
                loadScript(sUrl, function () {
...
function backHome(){
    if(!/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) {
        if(isCoutDown>1 || IS_READ>0){
            ...
            window.location.href="//lol.qq.com/";
        }
    }else{
        isZM(function () {
            if(isCoutDown>1 || IS_READ>0){
...
/* #t6Hl8#789B5AC059FBF4C166ADFC13A63A4BDE */