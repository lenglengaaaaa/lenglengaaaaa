var TransZone = {
    ...
    TransferZoneList:function (page) {
        ...
        need("biz.login", function (LoginManager) {
            LoginManager.checkLogin(function () {
                var sUrl = "//lol.sw.game.qq.com/lol/lwdcommact/a20210106transferzone/a20210106transferzone/TransferZoneList?page="+page+"&pageSize=5&r1=TransferZoneList_RES";
                loadScript(sUrl, function () {
...
}/* #t6Hl8#0825DE363C4440C7C1A1CDF9325C9F58 */