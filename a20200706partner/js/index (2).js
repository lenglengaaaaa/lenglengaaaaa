    ...
    function hidediv(){
        setTimeout(function(){
            ...
            $('.header .slogan').css({
                width:'100%',
                height:'1.21rem',
                background:'url(//game.gtimg.cn/images/lpl/act/a20200706partner/slogan1.png) no-repeat center /4.17rem 1.21rem',
            ...
            $('.logo').css({top:'.54rem',left:'.15rem', width:'.95rem',height:'.29rem'});
            $('.logo1').css({top:'.54rem',left:'1.7rem', width:'1.13rem',height:'.2rem'});
            $('.logo-nine').css({top:'.4rem',left:'1.16rem', width:'.52rem',height:'.53rem'});
        },3000)
    }
    hidediv();
...
/* #t6Hl8#F30A01C97B33E4E86FCFD676944F4AC1 */